...
def offpolicy_l2ew_debug_trainer(
        policy: BasePolicy,
        ...
        with tqdm.tqdm(total=step_per_epoch, desc=f'Epoch #{epoch}',
            ...
            while t.n < t.total:  # this is shown in the progress bar, represents the update times
                ...
                if len(train_collector.buffer) == 0:
                    train_collector.collect(n_step=collect_per_step, log_fn=log_fn)
                ...
                for i in range(n_policy):
                    ...
                    for _ in range(update_times):
                        policy.learn(train_collector.sample(batch_size))
                    ...
                    for j in range(n_sample):
                        ...
                        i_values.append(policy.check_intrisic_value(explore_collector.buffer[indexes]))
                ...
                for i in range(update_per_step * min(
                        collect_data_num // collect_per_step, t.total - t.n)):
                    global_step += 1
