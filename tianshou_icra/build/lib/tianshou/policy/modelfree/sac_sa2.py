...
class SACSA2Policy(DDPGPolicy):
    ...
    def learn(self, batch, **kwargs):
        ...
        with torch.no_grad():
            ...
            current_next_q1 = self.critic1_old(batch_val.obs_next, obs_next_result_tmp.act)
            current_next_q2 = self.critic2_old(batch_val.obs_next, obs_next_result_tmp.act)
        ...
        skip = (deltaE > 0) and (np.random.rand() > 0.5)
        if skip: # it is worse
