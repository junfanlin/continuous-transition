...
class SACMUTRIRB2IBPolicy(DDPGPolicy):
    ...
    def learn(self, batch, **kwargs):
        ...
        trans_diff = (trans_mix - (trans_pred + targ_blend * (trans_pred_next - trans_pred))).pow(2).mean(-1, keepdim=True).detach()
        ...
        result = {
            ...
            'alpha': alpha,
            'beta': beta.mean().item(),
            'loss/trans_diff': trans_diff.mean().item(),
