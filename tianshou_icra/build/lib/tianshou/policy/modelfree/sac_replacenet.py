...
class SACRPPolicy(DDPGPolicy):
    ...
    def __init__(self,
                 ...
                 actor_r: torch.nn.Module,
                 actor_optim_r: torch.optim.Optimizer,
                 critic1_r: torch.nn.Module,
                 critic1_optim_r: torch.optim.Optimizer,
                 critic2_r: torch.nn.Module,
                 critic2_optim_r: torch.optim.Optimizer,
        ...
        self.actor_r, self.actor_optim_r = actor_r, actor_optim_r
        self.critic1_r, self.critic1_old_r = critic1_r, deepcopy(critic1_r)
        self.critic1_old_r.eval()
        self.critic1_optim_r = critic1_optim_r
        self.critic2_r, self.critic2_old_r = critic2_r, deepcopy(critic2_r)
        self.critic2_old_r.eval()
        self.critic2_optim_r = critic2_optim_r
    ...
    def train(self, mode=True) -> torch.nn.Module:
        ...
        self.actor_r.train(mode)
        self.critic1_r.train(mode)
        self.critic2_r.train(mode)
        return self
