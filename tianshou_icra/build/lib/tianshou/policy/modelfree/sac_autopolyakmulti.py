...
class SACAPMPolicy(DDPGPolicy):
    ...
    def learn(self, batch, **kwargs):
        ...
        current_next_q = torch.min(current_next_q1, current_next_q2) - self._alpha.detach() * obs_result_tmp.log_prob
